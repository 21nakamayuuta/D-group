...
public class MyPageController {
	...
	public String mypage(@ModelAttribute("MyPageForm") MypageForm form,
	...
	public String nameChange(@Validated @ModelAttribute("MyPageForm") MypageForm form, BindingResult binding,
			@ModelAttribute("RecipeSearch") SearchForm RecipeForm, Model model) {
		// 一旦バリデーションを無しでやっています
		/*
		 * if (binding.hasErrors()) { return "mypage"; }
		 */
		UserInfo user = (UserInfo) session.getAttribute("user");
	...
	public String passChange(@Validated @ModelAttribute("MyPageForm") MypageForm form, BindingResult binding,
			@ModelAttribute("RecipeSearch") SearchForm RecipeForm, Model model) {
		// 一旦バリデーションを無しでやっています.
		UserInfo user = (UserInfo) session.getAttribute("user");
	...
	public String delete(@Validated @ModelAttribute("MyPageForm") MypageForm form, BindingResult binding,
		...
		goodService.deleteGoodByRecipeId(Integer.parseInt(ButtonValue));
		madeRecipeService.deleteMadeRecipeId(Integer.parseInt(ButtonValue));
		postRecipeService.deletePostRecipe(Integer.parseInt(ButtonValue));
	...
	public String edit(@Validated @ModelAttribute("MyPageForm") MypageForm form, BindingResult binding,
			@ModelAttribute("RecipeSearch") SearchForm RecipeForm, @ModelAttribute("editInfo") EditForm editform,
