...
public class Images {
	public String imagePathSave(MultipartFile imageFile, Integer userId) {
		...
		Path uploadfile = Paths.get("C:/D-group/group_d/src/main/webapp/imgs/" + filename + extention);
	...
	// try {
	// BufferedImage original = ImageIO.read(new
	// File("C:/D-group/group_d/src/main/webapp" + filepath));
	//
	// int resizeW = 200;
	// int resizeH = 200;
	//
	...
	//
	// // 画像サイズ変更
	// BufferedImage scaleImg = new BufferedImage(resizeW, resizeH,
	...
	//
	// //指定したfileに上書き
	// try (ImageOutputStream imageStream = ImageIO.createImageOutputStream(new
	// File("\"C:/D-group/group_d/src/main/webapp" + filepath))) {
